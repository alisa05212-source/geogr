...
const GEO_DATA = [
    ...
    // --- TRIBUTARIES (OTHERS) ---
    { id: "seim", type: "river", name: "Сейм", length: "748 км", color: "#93c5fd", description: "Притока Десни.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Seim_River_Baturyn.jpg/800px-Seim_River_Baturyn.jpg", path: [[51.6, 35.5], [51.5, 35.0], [51.4, 34.5], [51.4, 34.0], [51.4, 33.5], [51.45, 32.7]] },
    { id: "pripyat", type: "river", name: "Прип'ять", length: "761 км", color: "#60a5fa", description: "Права притока Дніпра.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Pripyat_River_bridge.jpg/800px-Pripyat_River_bridge.jpg", path: [[51.7, 24.3], [51.75, 24.8], [51.8, 25.5], [51.85, 26.0], [51.9, 26.5], [51.85, 27.2], [51.8, 28.0], [51.5, 29.0], [51.3, 30.2]] },
    ...
    { id: "molochnyi", type: "lake", name: "Молочний лиман", area: "168 км²", description: "Орнітологічний заказник.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Molochnyi_Lyman_Sunset.jpg/800px-Molochnyi_Lyman_Sunset.jpg", color: "#2dd4bf", center: [46.52, 35.35], radius: 7500 }, // NEW
