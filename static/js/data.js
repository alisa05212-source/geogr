...
const GEO_DATA = [
    ...
    { id: "psel", type: "river", name: "Псел", length: "717 км", color: "#60a5fa", description: "Ліва притока Дніпра. Одна з найбільш звивистих річок України.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e6/Psel_river_near_Hadyach.jpg/800px-Psel_river_near_Hadyach.jpg", origin: "Від адигейського 'пс' (вода) та 'е' (річка), або давньогрецького 'псілос' (пустий).", path: [[51.0, 35.0], [50.5, 34.5], [50.0, 34.0], [49.5, 33.8], [49.0, 33.5]] },
    { id: "khorol", type: "river", name: "Хорол", length: "308 км", color: "#60a5fa", description: "Права притока Псла. На ній розташований знаменитий курорт Миргород.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Khorol_River_Myrhorod.jpg/800px-Khorol_River_Myrhorod.jpg", origin: "Від іранського 'ху' (добрий) та 'ра' (вода/потік).", path: [[50.3, 33.5], [50.0, 33.6], [49.7, 33.4], [49.4, 33.5]] },
    { id: "vorskla", type: "river", name: "Ворскла", length: "464 км", color: "#60a5fa", description: "Ліва притока Дніпра. Місце знаменитої Полтавської битви.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/52/Vorskla_River_Poltava.jpg/800px-Vorskla_River_Poltava.jpg", origin: "Від скіфо-сарматського 'вор' (білий) та 'сколо' (вода/річка).", path: [[50.5, 35.8], [50.2, 35.5], [49.8, 35.0], [49.5, 34.5], [49.0, 34.2], [48.8, 34.1]] },
    { id: "oril", type: "river", name: "Оріль", length: "346 км", color: "#60a5fa", description: "Ліва притока Дніпра. Вважається однією з найчистіших річок степової зони.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c5/Oril_River.jpg/800px-Oril_River.jpg", origin: "Від тюркського 'äri' (чистий) або 'airy' (вигин).", path: [[49.1, 35.5], [48.9, 35.0], [48.7, 34.6]] },
    { id: "samara", type: "river", name: "Самара", length: "320 км", color: "#60a5fa", description: "Ліва притока Дніпра. Відома своєю плавневою екосистемою.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Samara_River_Dnipro.jpg/800px-Samara_River_Dnipro.jpg", origin: "Ймовірно від тюркського 'семер' (сідло, вигин) або індоіранського 'сама' (чорний).", path: [[48.8, 36.5], [48.6, 36.0], [48.5, 35.5], [48.45, 35.1]] },
    { id: "trubizh", type: "river", name: "Трубіж", length: "113 км", color: "#60a5fa", description: "Ліва притока Дніпра. На ній стоїть стародавній Переяслав.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Trubizh_River.jpg/800px-Trubizh_River.jpg", origin: "Від давньоруського 'трубити' (через швидкий потік у гирлі).", path: [[50.5, 31.2], [50.3, 31.4], [50.0, 31.5]] },
    { id: "supiy", type: "river", name: "Супій", length: "144 км", color: "#60a5fa", description: "Ліва притока Дніпра. Протікає через Яготин.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/c2/Supiy_River.jpg/800px-Supiy_River.jpg", origin: "Від тюркського 'су' (вода) та 'пій' (чистий).", path: [[50.4, 31.8], [50.1, 31.9], [49.8, 32.0]] },
    { id: "ros", type: "river", name: "Рось", length: "346 км", color: "#60a5fa", description: "Права притока Дніпра. Одна з найкрасивіших річок центральної України.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/2/2f/Ros_River_Bila_Tserkva.jpg/800px-Ros_River_Bila_Tserkva.jpg", origin: "Від праслов'янського 'роса' або від племені росів.", path: [[49.2, 29.5], [49.5, 30.0], [49.6, 30.5], [49.4, 31.0], [49.5, 31.5]] },
    { id: "tiasmyn", type: "river", name: "Тясмин", length: "164 км", color: "#60a5fa", description: "Права притока Дніпра. Утворює унікальну петлю біля Чигирина.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/91/Tiasmyn_Canyon.jpg/800px-Tiasmyn_Canyon.jpg", origin: "Від тюркського 'таш' (камінь).", path: [[49.0, 31.8], [49.1, 32.2], [49.2, 32.6], [49.0, 32.8]] },
    { id: "inhulets", type: "river", name: "Інгулець", length: "549 км", color: "#60a5fa", description: "Права притока Дніпра. Основна річка Кривбасу, що живить промисловість регіону.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1a/Inhulets_River_Kryvyi_Rih.jpg/800px-Inhulets_River_Kryvyi_Rih.jpg", origin: "Від тюркського 'In' (печера) та 'Gül' (річка) — 'Печерна річка'.", path: [[48.5, 32.5], [48.2, 33.0], [47.8, 33.2], [47.5, 33.0], [47.2, 32.8], [46.7, 32.7]] },
    { id: "saksahan", type: "river", name: "Саксагань", length: "144 км", color: "#60a5fa", description: "Ліва притока Інгульця. Більша частина річки протікає через Кривий Ріг.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/c/ca/Saksagan_River.jpg/800px-Saksagan_River.jpg", origin: "З тюркської 'Sagsagan' (сорока).", path: [[48.4, 34.0], [48.2, 33.8], [48.0, 33.5], [47.9, 33.3]] },
    { id: "bazavluk", type: "river", name: "Базавлук", length: "157 км", color: "#60a5fa", description: "Права притока Дніпра (впадає в Каховське вдсх). Історичний центр запорозького козацтва.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/3d/Bazavluk_River.jpg/800px-Bazavluk_River.jpg", origin: "Від тюркського 'Buzav' (теля) та 'lyq' (місце) — 'Теляче місце'.", path: [[48.3, 34.2], [48.0, 34.1], [47.7, 33.9], [47.5, 34.0]] },
    ...
    { id: "uzh_polissya", type: "river", name: "Уж (Полісся)", length: "256 км", color: "#60a5fa", description: "Притока Прип'яті. Протікає через зону відчуження ЧАЕС.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Uzh_River_Korosten.jpg/800px-Uzh_River_Korosten.jpg", origin: "Від старослов'янського 'уж' (вигин) або балтійского 'usis' (ясен).", path: [[50.7, 28.2], [50.9, 28.6], [51.1, 29.2], [51.2, 29.8], [51.25, 30.2]] },
    ...
    // --- DNIESTER BASIN ---
    { id: "stryi", type: "river", name: "Стрий", length: "232 км", color: "#06b6d4", description: "Найбільша права притока Дністра. Одна з найшвидших річок Карпат.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Stryi_River.jpg/800px-Stryi_River.jpg", origin: "Назва походить від праслов'янського 'stry' (течія, струмінь). Споріднене зі словом 'струмінь'.", path: [[49.0, 23.2], [49.1, 23.5], [49.2, 23.9], [49.3, 24.2]] },
    { id: "zbruch", type: "river", name: "Збруч", length: "244 км", color: "#06b6d4", description: "Ліва притока Дністра. Історична межа між Галичиною та Поділлям.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/3/36/Zbruch_River.jpg/800px-Zbruch_River.jpg", origin: "Назва може походити від діалектного 'збруч' (болото) або від слова 'бруч' (течія). Відома через Збруцького ідола.", path: [[49.6, 26.2], [49.3, 26.3], [49.0, 26.2], [48.5, 26.4]] },
    { id: "seret", type: "river", name: "Серет", length: "242 км", color: "#06b6d4", description: "Ліва притока Дністра. Протікає через Тернопіль і Чортків.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/1/15/Seret_River_Chortkiv.jpg/800px-Seret_River_Chortkiv.jpg", origin: "Від іранського 'seraka' (потік) або фракійського 'seret' (течія). Спільна назва для багатьох річок регіону.", path: [[49.8, 25.3], [49.6, 25.5], [49.3, 25.6], [49.0, 25.7], [48.6, 25.8]] },
    { id: "strypa", type: "river", name: "Стрипа", length: "147 км", color: "#06b6d4", description: "Ліва притока Дністра. Відома своїми водоспадами (Бучач).", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/7a/Strypa_River_Buchach.jpg/800px-Strypa_River_Buchach.jpg", origin: "Від праслов'янського 'струп' (швидкий потік, струмінь).", path: [[49.7, 25.2], [49.4, 25.3], [49.1, 25.4], [48.8, 25.4]] },
    { id: "limnytsia", type: "river", name: "Лімниця", length: "122 км", color: "#06b6d4", description: "Права притока Дністра. Вважається найчистішою річкою Європи.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Limnytsia_River.jpg/800px-Limnytsia_River.jpg", origin: "Від 'лимна' (озеро) або балтійського 'lym' (вогкий, болотистий).", path: [[48.6, 24.0], [48.8, 24.3], [49.0, 24.6]] },
    ...
    { id: "prut", type: "river", name: "Прут", length: "967 км", color: "#818cf8", description: "Притока Дунаю. Протікає через Яремче та Чернівці.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/75/Prut_River_Yaremche.jpg/800px-Prut_River_Yaremche.jpg", path: [[48.4, 24.5], [48.5, 25.0], [48.4, 25.5], [48.2, 26.5], [47.8, 27.5], [47.0, 28.0], [46.0, 28.2]] },
    { id: "uzh_zakarpattia", type: "river", name: "Уж (Закарпаття)", length: "133 км", color: "#818cf8", description: "Річка на Закарпатті. Довжина в межах України - 107 км.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Uzh_River_Uzhhorod.jpg/800px-Uzh_River_Uzhhorod.jpg", path: [[48.9, 22.8], [48.7, 22.5], [48.6, 22.3]] },
    { id: "latorytsia", type: "river", name: "Латориця", length: "188 км", color: "#818cf8", description: "Протікає через Мукачево. Притока Бодрогу.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Latorica_River_Mukachevo.jpg/800px-Latorica_River_Mukachevo.jpg", path: [[48.7, 23.0], [48.5, 22.8], [48.4, 22.4]] },
    ...
    // DANUBE & SOUTH
    { id: "yalpuh", type: "lake", name: "Ялпуг", tags: ["top"], area: "149 км²", description: "Найбільше природне прісноводне озеро України.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/d/df/Yalpug_lake.jpg/800px-Yalpug_lake.jpg", color: "#06b6d4", center: [45.42, 28.60], radius: 10000, origin: "Назва має коріння в тюркських мовах, що означає 'порослий берег'." },
    { id: "kugurluy", type: "lake", name: "Кугурлуй", area: "82 км²", description: "Заплавне озеро на Одещині, що з'єднане з Ялпугом.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Danube_Delta_Pelicans.jpg/800px-Danube_Delta_Pelicans.jpg", color: "#06b6d4", center: [45.28, 28.65], radius: 8000, origin: "Від турецького 'kugulu' (лебедине). Численні популяції кучерявого пелікана." },
    ...
    { id: "donuzlav", type: "lake", name: "Донузлав", tags: ["top"], area: "48 км²", description: "Найглибше озеро Криму. Солоне озеро, з'єднане з морем. Колишня військово-морська база.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Donuzlav_Lake.jpg/800px-Donuzlav_Lake.jpg", color: "#0ea5e9", center: [45.35, 33.00], radius: 9000, origin: "Назва походить з тюркської 'Донуз' (кабан) та 'лав' (вода/місце) — 'Місце, де кабани пили воду'." },
    { id: "sasyk_syvash", type: "lake", name: "Сасик-Сиваш", area: "75 км²", description: "Найбільше озеро Криму. Відоме своїми соляними промислами та рожевим відтінком через водорості Dunaliella salina.", image: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a2/Sasyk_Syvash_Lake.jpg/800px-Sasyk_Syvash_Lake.jpg", color: "#f472b6", center: [45.18, 33.50], radius: 8000, origin: "З кримськотатарської 'Sasiq' (смердючий) та 'Sivaş' (бруд, багно). Назва відображає специфічний запах сірководню." },
