...
const GEO_DATA = [
    ...
    { id: "desna", type: "river", name: "Десна", length: "1130 км", color: "#0ea5e9", description: "Зачарована річка Олександра Довженка.", origin: "Від давньослов'янського 'десниця' — права рука (права сторона)", path: [[52.2, 33.3], [52.1, 33.2], [51.9, 33.0], [51.7, 32.8], [51.6, 32.5], [51.5, 32.2], [51.4, 31.8], [51.3, 31.4], [51.2, 31.0], [50.8, 30.8], [50.55, 30.55]] },
    { id: "seim", type: "river", name: "Сейм", length: "748 км", color: "#0ea5e9", description: "Найбільша притока Десни.", path: [[51.6, 35.5], [51.5, 35.0], [51.4, 34.5], [51.4, 34.0], [51.4, 33.5], [51.45, 32.7]] },
    { id: "sula", type: "river", name: "Сула", length: "363 км", color: "#0ea5e9", description: "Ліва притока Дніпра. Історична межа Посульської оборонної лінії.", path: [[50.8, 33.5], [50.5, 33.2], [50.2, 33.0], [49.8, 32.8], [49.5, 32.7]] },
    { id: "psel", type: "river", name: "Псел", length: "717 км", color: "#0ea5e9", description: "Мальовнича річка, що протікає через Полтавщину.", path: [[51.0, 35.0], [50.5, 34.5], [50.0, 34.0], [49.5, 33.8], [49.0, 33.5]] },
    { id: "vorskla", type: "river", name: "Ворскла", length: "464 км", color: "#0ea5e9", description: "На цій річці відбулася знаменита Полтавська битва.", origin: "Від скіфського 'вор' (білий) та 'сколо' (вода).", path: [[50.5, 35.8], [50.2, 35.5], [49.8, 35.0], [49.5, 34.5], [49.0, 34.2], [48.8, 34.1]] },
    { id: "samara", type: "river", name: "Самара", length: "320 км", color: "#0ea5e9", description: "Ліва притока Дніпра. Впадає в районі міста Дніпро.", path: [[48.8, 36.5], [48.6, 36.0], [48.5, 35.5], [48.45, 35.1]] },
    { id: "trubizh", type: "river", name: "Трубіж", length: "113 км", color: "#0ea5e9", description: "На Трубежі розташований Переяслав.", path: [[50.5, 31.2], [50.3, 31.4], [50.0, 31.5]] },

    // --- DNIEPER TRIBUTARIES (RIGHT BANK) ---
    { id: "pripyat", type: "river", name: "Прип'ять", length: "761 км", color: "#0ea5e9", description: "Найбільша за басейном притока Дніпра. Чорнобильська зона.", path: [[51.7, 24.3], [51.75, 24.8], [51.8, 25.5], [51.85, 26.0], [51.9, 26.5], [51.85, 27.2], [51.8, 28.0], [51.5, 29.0], [51.3, 30.2]] },
    { id: "teteriv", type: "river", name: "Тетерів", length: "365 км", color: "#0ea5e9", description: "Протікає через Житомир. Мальовничі скелясті береги.", path: [[49.8, 28.3], [50.2, 28.5], [50.3, 29.0], [50.5, 29.5], [50.8, 30.0], [51.0, 30.3]] },
    { id: "ros", type: "river", name: "Рось", length: "346 км", color: "#0ea5e9", description: "Історична батьківщина русичів.", path: [[49.2, 29.5], [49.5, 30.0], [49.6, 30.5], [49.4, 31.0], [49.5, 31.5]] },
    { id: "irpin", type: "river", name: "Ірпінь", length: "162 км", color: "#0ea5e9", description: "Річка-захисниця Києва. Унікальна система гребель.", path: [[50.0, 29.4], [50.3, 29.8], [50.5, 30.2], [50.8, 30.4]] },
    { id: "tiasmyn", type: "river", name: "Тясмин", length: "164 км", color: "#0ea5e9", description: "Права притока Дніпра. Центр Чигиринщини.", path: [[49.0, 31.8], [49.1, 32.2], [49.2, 32.6], [49.0, 32.8]] },
    { id: "inhulets", type: "river", name: "Інгулець", length: "549 км", color: "#0ea5e9", description: "Річка Кривбасу.", path: [[48.5, 32.5], [48.2, 33.0], [47.8, 33.2], [47.5, 33.0], [47.2, 32.8], [46.7, 32.7]] },

    // --- THE REMAINING MISSING RIVERS (FROM ATLAS) ---
    { id: "horyn", type: "river", name: "Горинь", length: "659 км", color: "#0ea5e9", description: "Притока Прип'яті.", path: [[50.0, 25.8], [50.2, 26.2], [50.5, 26.4], [50.8, 26.5], [51.2, 26.6], [51.5, 26.7], [51.8, 26.8]] },
    { id: "styr", type: "river", name: "Стир", length: "494 км", color: "#0ea5e9", description: "Протікає через Луцьк.", path: [[49.9, 25.2], [50.2, 25.1], [50.5, 25.2], [50.7, 25.3], [51.0, 25.5], [51.4, 25.8]] },
    { id: "sluch", type: "river", name: "Случ", length: "451 км", color: "#0ea5e9", description: "Притока Горині.", path: [[49.6, 26.7], [49.8, 27.2], [50.2, 27.5], [50.6, 27.3], [51.0, 26.8]] },
    { id: "khorol", type: "river", name: "Хорол", length: "308 км", color: "#0ea5e9", description: "Курорт Миргород.", path: [[50.3, 33.5], [50.0, 33.6], [49.7, 33.4], [49.4, 33.5]] },
    { id: "oril", type: "river", name: "Оріль", length: "346 км", color: "#0ea5e9", description: "Найчистіша річка степу.", path: [[49.1, 35.5], [48.9, 35.0], [48.7, 34.6]] },
    { id: "uzh_polissya", type: "river", name: "Уж (Полісся)", length: "256 км", color: "#0ea5e9", path: [[50.7, 28.2], [50.9, 28.6], [51.1, 29.2], [51.2, 29.8], [51.25, 30.2]] },
    { id: "seret", type: "river", name: "Серет", length: "242 км", color: "#0ea5e9", path: [[49.8, 25.3], [49.6, 25.5], [49.3, 25.6], [49.0, 25.7], [48.6, 25.8]] },
    { id: "strypa", type: "river", name: "Стрипа", length: "147 км", color: "#0ea5e9", path: [[49.7, 25.2], [49.4, 25.3], [49.1, 25.4], [48.8, 25.4]] },
    { id: "limnytsia", type: "river", name: "Лімниця", length: "122 км", color: "#0ea5e9", path: [[48.6, 24.0], [48.8, 24.3], [49.0, 24.6]] },
    { id: "saksahan", type: "river", name: "Саксагань", length: "144 км", color: "#0ea5e9", path: [[48.4, 34.0], [48.2, 33.8], [48.0, 33.5]] },
    { id: "bazavluk", type: "river", name: "Базавлук", length: "157 км", color: "#0ea5e9", path: [[48.3, 34.2], [48.0, 34.1], [47.7, 33.9], [47.5, 34.0]] },
